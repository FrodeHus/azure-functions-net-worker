    ...
    public class AuthenticationMiddleware : IFunctionsWorkerMiddleware
    {
        ...
        private async Task Authenticate(FunctionContext context, AuthenticationHeaderValue authenticationHeader, ILogger logger)
        {
            ...
            try
            {
                ...
                context.Items.Add("identity", principal);
            }
        ...
        {
            var configManager = new ConfigurationManager<OpenIdConnectConfiguration>($"{_config.Instance}{_config.TenantId}/v2.0/.well-known/openid-configuration", new OpenIdConnectConfigurationRetriever());
            ...
            var validIssuers = new string[] { oidcConfig.Issuer, $"https://sts.windows.net/{_config.TenantId}/" }; //support 1.0 issuer as well
